...
ADVANCED_JOB_SEARCHES = [
    ...
    # ─── ANDROID AUTOMATION ──────────────────────────────────────────────────
    # Channel: #appilot
    # Jobs involving physical Android devices, phone farms, emulators, ADB scripting.
    {
    ...
    # Jobs involving anti-detect browsers, fingerprint spoofing, residential proxies, multi-account workflows.
    {
    ...
    # Channel: #smm-bots
    # Jobs for automating social media engagement: SMM panels, Twitter/Instagram/Telegram bots, TikTok outreach.
    {
    ...
    # Catch-all for browser automation, bot scripting, and accessibility-based automation.
    {
        ...
        "query": "title:(bot development) OR title:(automation bot) OR title:(discord bot) OR title:(telegram bot)",
    ...
    },
    {
        ...
        "query": "title:(selenium automation) OR title:(puppeteer) OR title:(playwright automation)",
        "channel_id": 1359040738507358340,
        "filters": {}
    },
    {
