...
class OriginTrial:
    ...
    def to_json(self) -> T_JSON_DICT:
        ...
        json["tokensWithStatus"] = [
            i.to_json() for i in self.tokens_with_status
        ]
        return json
...
class Frame:
    ...
    def to_json(self) -> T_JSON_DICT:
        ...
        json["gatedAPIFeatures"] = [
            i.to_json() for i in self.gated_api_features
        ]
...
class WebAppManifest:
    ...
    def to_json(self) -> T_JSON_DICT:
        ...
        if self.prefer_related_applications is not None:
            json["preferRelatedApplications"] = (
                self.prefer_related_applications
            )
        if self.protocol_handlers is not None:
            json["protocolHandlers"] = [
                i.to_json() for i in self.protocol_handlers
            ]
        ...
        if self.scope_extensions is not None:
            json["scopeExtensions"] = [
                i.to_json() for i in self.scope_extensions
            ]
...
class BackForwardCacheNotRestoredExplanation:
    ...
    def from_json(
        ...
        return cls(
            ...
            details=(
                [
                    BackForwardCacheBlockingDetails.from_json(i)
...
def capture_screenshot(
    ...
    :param format_: *(Optional)*
     Image compression format (defaults to png).
    :param quality: *(Optional)*
     Compression quality from range [0..100] (jpeg only).
    :param clip: *(Optional)*
     Capture the screenshot of a given region only.
    :param from_surface: **(EXPERIMENTAL)** *(Optional)*
     Capture the screenshot from the surface, rather than the view.
     Defaults to true.
    :param capture_beyond_viewport: **(EXPERIMENTAL)** *(Optional)*
     Capture the screenshot beyond the viewport. Defaults to false.
    :param optimize_for_speed: **(EXPERIMENTAL)** *(Optional)*
...
def create_isolated_world(
    ...
    :param world_name: *(Optional)*
     An optional name which is reported in the Execution Context.
    :param grant_univeral_access: *(Optional)*
...
def get_installability_errors() -> (
    ...
    json = yield cmd_dict
    return [
        InstallabilityError.from_json(i) for i in json["installabilityErrors"]
    ]
...
def print_to_pdf(
    ...
    :param display_header_footer: *(Optional)*
     Display header and footer. Defaults to false.
    :param print_background: *(Optional)*
     Print background graphics. Defaults to false.
    :param scale: *(Optional)* Scale of the webpage rendering. Defaults to 1.
    :param paper_width: *(Optional)*
     Paper width in inches. Defaults to 8.5 inches.
    :param paper_height: *(Optional)*
     Paper height in inches. Defaults to 11 inches.
    :param margin_top: *(Optional)*
     Top margin in inches. Defaults to 1cm (~0.4 inches).
    :param margin_bottom: *(Optional)*
     Bottom margin in inches. Defaults to 1cm (~0.4 inches).
    :param margin_left: *(Optional)*
     Left margin in inches. Defaults to 1cm (~0.4 inches).
    :param margin_right: *(Optional)*
     Right margin in inches. Defaults to 1cm (~0.4 inches).
    :param page_ranges: *(Optional)*
    ...
    :param generate_tagged_pdf: **(EXPERIMENTAL)** *(Optional)*
     Whether or not to generate tagged (accessible) PDF.
     Defaults to embedder choice.
    :param generate_document_outline: **(EXPERIMENTAL)** *(Optional)*
...
def reload(
    ...
    :param ignore_cache: *(Optional)*
     If true, browser cache is ignored (as if the user pressed Shift+refresh).
    :param script_to_evaluate_on_load: *(Optional)*
     If set, the script will be injected into all frames
     of the inspected page after reload.
     Argument will be ignored if reloading dataURL origin.
    :param loader_id: **(EXPERIMENTAL)** *(Optional)*
     If set, an error will be thrown if the target page's main frame's loader
     ID does not match the provided id.
     This prevents accidentally reloading an unintended target in case there's
     a racing navigation.
    """
    params: T_JSON_DICT = dict()
...
class FrameAttached:
    ...
    #: JavaScript stack trace of when frame was attached,
...
class FrameScheduledNavigation:
    ...
    #: The navigation is not guaranteed to start.
    delay: float
    #: The reason for the navigation.
    reason: ClientNavigationReason
...
class JavascriptDialogOpening:
    ...
    #: Execution can be resumed via calling Page.handleJavaScriptDialog.
...
class BackForwardCacheNotUsed:
    ...
    #: Tree structure of reasons why the page could not be
    #: cached for each frame.
