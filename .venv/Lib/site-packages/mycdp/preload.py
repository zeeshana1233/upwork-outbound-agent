...
class SpeculationAction(enum.Enum):
    ...
    It corresponds to mojom::SpeculationAction
...
class PreloadingAttemptKey:
    ...
    and not the final url that is navigated to.
    For example, prerendering allows same-origin main frame navigations
    during the attempt, but the attempt is still keyed with the initial URL.
    """
    loader_id: network.LoaderId
...
class PrerenderStatusUpdated:
    ...
    #: This is used to give users more information
    #: about the name of Mojo interface that is incompatible with prerender
    #: and has caused the cancellation of the attempt.
    disallowed_mojo_interface: typing.Optional[str]
    mismatched_headers: typing.Optional[
        typing.List[PrerenderMismatchedHeaders]
    ]
