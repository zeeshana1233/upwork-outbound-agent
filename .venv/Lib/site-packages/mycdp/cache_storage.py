...
def request_cache_names(
    ...
    :param security_origin: *(Optional)*
    ...
    :param storage_bucket: *(Optional)* Storage bucket.
     If not specified, it uses the default bucket.
...
def request_entries(
    ...
    :param path_filter: *(Optional)* If present,
    ...
    :returns: A tuple with the following items:
        ...
        1. **returnCount** - Count of returned entries from this storage. If
        pathFilter is empty, it is the count of all entries from this storage.
    """
    params: T_JSON_DICT = dict()
    params["cacheId"] = cache_id.to_json()
