...
class SafetyTipInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SafetyTipInfo:
        return cls(
            safety_tip_status=SafetyTipStatus.from_json(
...
class VisibleSecurityState:
    ...
    def to_json(self) -> T_JSON_DICT:
        ...
        json["securityStateIssueIds"] = [
            i for i in self.security_state_issue_ids
        ]
    ...
    def from_json(cls, json: T_JSON_DICT) -> VisibleSecurityState:
        return cls(
            ...
            certificate_security_state=(
                CertificateSecurityState.from_json(
                    json["certificateSecurityState"]
                )
...
class CertificateError:
    ...
    Note: this event does not fire if the certificate error has been allowed
